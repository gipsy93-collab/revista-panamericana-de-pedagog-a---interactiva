...
// Conocimiento base de PEPA (Simplificado para el Bot)
...
REGLAS: Responde siempre en texto plano. Usa emojis. Sé académica pero cercana.`;
...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  try {
    ...
    return res.status(200).send('ok'); // Siempre devolver 200 a Telegram para evitar bucles de error
  }
}
