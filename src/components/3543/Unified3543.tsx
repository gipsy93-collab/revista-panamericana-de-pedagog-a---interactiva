    ...
    <div className="relative min-h-screen bg-white text-zinc-900 font-sans pt-20 overflow-x-hidden selection:bg-orange-600 selection:text-white">
      ...
      <header className="fixed top-0 left-0 right-0 z-[100] bg-white border-b-8 border-black shadow-[0_4px_0_0_rgba(0,0,0,0.1)]">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          <button
            onClick={onBack}
            className="group flex items-center gap-3 bg-black text-white px-6 py-3 border-4 border-black hover:bg-orange-600 transition-colors shadow-[4px_4px_0_0_#9a3412] hover:translate-x-[-2px] hover:translate-y-[-2px] hover:shadow-[6px_6px_0_0_#9a3412] active:translate-x-[2px] active:translate-y-[2px] active:shadow-none"
          >
          ...
          <div className="hidden md:flex items-center gap-4">
             ...
             <span className="font-mono text-[10px] uppercase font-black tracking-widest opacity-40">REF_3543 // EDUCACIÓN_SUPERIOR_COVID</span>
          </div>
        </div>
      </header>

      <main className="relative z-0">
        <Hero3543 onStart={scrollToContent} />
      ...
      <footer className="bg-black py-32 px-6 border-t-[20px] border-zinc-900 text-center relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto relative z-10 text-white">
          ...
          <p className="font-serif text-xl italic text-slate-400 mb-12 leading-relaxed">
            Ávila-Fuenmayor, G. J. (2026). <span className="text-white not-italic font-bold">Desafíos de la educación superior en tiempos de COVID-19</span>. <span className="text-orange-500">Revista Panamericana de Pedagogía</span>, 41, e3543.
          </p>
          <div className="flex flex-col md:flex-row justify-center items-center gap-10">
             <div className="bg-white text-black px-8 py-4 border-4 border-black font-mono text-sm font-black uppercase tracking-widest shadow-[8px_8px_0_0_#9a3412]">
