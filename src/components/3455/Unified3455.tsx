...
export default function Unified3455({ onBack }: Props) {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
      ...
      <header className="fixed top-0 left-0 right-0 z-[100] bg-white border-b-8 border-black shadow-[0_4px_0_0_rgba(0,0,0,0.1)]">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-4">
             ...
             <span className="font-mono text-[10px] uppercase font-black tracking-widest opacity-40">REF_3455 // APRENDIZAJE_ACTIVO_MATEMÁTICAS</span>
          </div>
        </div>
      </header>
      ...
      <footer className="bg-black py-32 px-6 border-t-[20px] border-zinc-900 text-center relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto relative z-10 text-white">
          ...
          <p className="font-serif text-xl italic text-slate-400 mb-12 leading-relaxed">
            Chan-Chi & Poot-May (2026). <span className="text-white not-italic font-bold">Aprendizaje activo en la enseñanza de las matemáticas</span>. <span className="text-emerald-500">Revista Panamericana de Pedagogía</span>, 41, e3455.
          </p>
