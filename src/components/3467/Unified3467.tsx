      ...
      <header className="fixed top-0 left-0 right-0 z-[100] bg-white border-b-8 border-black shadow-[0_4px_0_0_rgba(0,0,0,0.1)]">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-4">
             ...
             <span className="font-mono text-[10px] uppercase font-black tracking-widest opacity-40">REF_3467 // ENSEÑANZA_HISTORIA</span>
          </div>
        </div>
      </header>
      ...
      <footer className="bg-black py-32 px-6 border-t-[20px] border-zinc-900 text-center relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto relative z-10 text-white">
          ...
          <p className="font-serif text-xl italic text-slate-400 mb-12 leading-relaxed">
            Vallejos-Parás et al. (2026). <span className="text-white not-italic font-bold">Enseñanza de la historia y pensamiento crítico</span>. <span className="text-rose-500">Revista Panamericana de Pedagogía</span>, 41, e3467.
          </p>
