...
import { ShieldAlert, Users, PhoneCall, Sparkles, HeartPulse, GraduationCap, Smartphone, Activity, Target } from 'lucide-react';
          ...
          <div className="grid lg:grid-cols-12 gap-16 items-start">
            ...
            <div className="lg:col-span-8">
              <div className="bg-zinc-900 p-12 md:p-24 border-[16px] border-black shadow-[30px_30px_0_0_#e11d48] rotate-1 relative group mb-12">
                 ...
                 <p className="text-3xl md:text-5xl font-serif italic text-white/90 leading-tight relative z-10">
                   "El avance tecnológico relega a los adultos mayores, limitando su autonomía. Se les estigmatiza como 'demasiado mayores' para aprender."
                 </p>
              </div>
              ...
              <div className="bg-white border-8 border-black p-10 shadow-[15px_15px_0_0_#000] -rotate-1">
                 <h4 className="font-display text-2xl uppercase font-black mb-6 flex items-center gap-3">
                    <GraduationCap className="text-rose-600" /> Educomunicación_
                 </h4>
                 <p className="text-3xl font-display uppercase font-black tracking-tighter leading-none italic">
                    Estudio de 27 adultos mayores sobre la reserva cognitiva y el envejecimiento activo_
                 </p>
              </div>
            </div>
            ...
            <div className="lg:col-span-4 space-y-8">
              <CinematicCard color="bg-zinc-50" title="BARRERA_ETARIA" icon={ShieldAlert} className="shadow-[10px_10px_0_0_#e11d48]">
                 <p className="text-lg font-bold leading-snug">El temor al error y al fraude bancario frena la adopción en sectores críticos.</p>
              </CinematicCard>
              ...
              <div className="bg-rose-600 text-white p-8 border-4 border-black shadow-[8px_8px_0_0_#000] rotate-2 relative group overflow-hidden">
                 ...
                 <p className="text-sm font-bold border-l-4 border-white pl-4 italic leading-relaxed">
                   La principal motivación para aprender es el vínculo familiar y la comunicación TRIC.
                 </p>
              </div>
            </div>
          </div>
      ...
      <WaveSection topColor="#fff1f2" bottomColor="#ffffff" variant="steps">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-20">
            ...
            <PremiumTitle className="items-center" subtitle="RESULTADOS EMPÍRICOS">Pilares_del_Giro_</PremiumTitle>
          </div>
              ...
              <AnimatePresence mode="wait">
                ...
                >
                  ...
                  <div className="bg-zinc-900 text-white p-10 border-4 border-black rotate-[-1deg]">
                    <h4 className="font-mono text-[10px] uppercase font-black mb-4 tracking-widest text-rose-400">HALLAZGO_DE_CAMPO</h4>
                    {activeDimension === 0 && <p className="font-display text-sm uppercase font-black italic tracking-tighter">"El uso de teléfonos se ha convertido en una herramienta fundamental para comunicarse con familiares."</p>}
                    {activeDimension === 1 && <p className="font-display text-sm uppercase font-black italic tracking-tighter">No depender de otros devuelve la dignidad. Valoración inmensa de resolver problemas solos.</p>}
                    {activeDimension === 2 && <p className="font-display text-sm uppercase font-black italic tracking-tighter">Barrera emocional: temor al robo bancario y a equivocarse con los botones. Miedo al 'daño' irreversible.</p>}
                    {activeDimension === 3 && <p className="font-display text-sm uppercase font-black italic tracking-tighter">La paciencia intergeneracional es vital. El aliento de amigos y familia es el detonante de la confianza.</p>}
                  </div>
                </motion.div>
              </AnimatePresence>
            </div>
      ...
      <WaveSection topColor="#ffffff" bottomColor="#f8fafc" variant="dramatic">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-24">
            ...
            <PremiumTitle className="items-center" subtitle="TECNOLOGÍAS DE LA RELACIÓN">Vínculos_TRIC_</PremiumTitle>
          </div>

          <BrutalQuote className="text-4xl font-serif italic mb-32 shadow-[30px_30px_0_0_#000] rotate-1">
             "La tecnología ha facilitado un aumento de la autonomía de los adultos mayores, contrarrestando el estigma y combatiendo profundamente la soledad."
          </BrutalQuote>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
             {[
               { icon: GraduationCap, color: 'bg-rose-600', text: 'Plasticidad Cerebral' },
               { icon: HeartPulse, color: 'bg-zinc-900', text: 'Bienestar Afectivo' },
               { icon: ShieldAlert, color: 'bg-blue-600', text: 'Entornos de Confianza' }
             ].map((it, i) => (
      ...
      <WaveSection topColor="#f8fafc" bottomColor="#ffffff" variant="wavy">
        <div className="max-w-6xl mx-auto text-center pb-40">
           ...
           <div className="bg-zinc-950 text-white p-20 border-[12px] border-black text-center relative overflow-hidden shadow-[25px_25px_0_0_#fde047] rotate-1 mt-20">
              <div className="absolute top-0 left-0 p-8 font-mono text-[10px] opacity-20 uppercase tracking-widest font-black">SILVER_TECH_REPORT_3198</div>
              <p className="text-4xl md:text-7xl font-display uppercase font-black leading-none mb-12 italic">
                Aprender es <span className="text-rose-500">vivir</span>; conectar es <span className="text-blue-600">permanecer</span>_
              </p>
