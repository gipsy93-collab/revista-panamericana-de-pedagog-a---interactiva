    ...
    <section className="min-h-screen flex flex-col justify-center items-center text-center px-6 py-32 bg-[#0F172A] relative overflow-hidden border-b-[20px] border-black">
      ...
      >
        ...
        <div className="relative mb-8">
          ...
          <div className="text-[12rem] md:text-[24rem] font-display uppercase leading-[0.7] text-white drop-shadow-[20px_20px_0_#F4A261]" style={{ WebkitTextStroke: '4px black' }}>
        ...
        <div className="max-w-4xl mx-auto space-y-10 bg-white text-black p-12 border-8 border-black shadow-[25px_25px_0_0_#3b82f6] rotate-1 mb-20 relative overflow-hidden group">
          <div className="absolute top-0 right-0 p-4 font-mono text-[10px] opacity-10 uppercase group-hover:opacity-100 transition-opacity font-black">CETis_74_ANALYTICS</div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 text-left w-full max-w-6xl">
          <CinematicCard color="bg-[#1e293b]" className="text-white shadow-[12px_12px_0_0_#F4A261] border-teal-500" title="LA_MUESTRA">
          ...
          <CinematicCard color="bg-[#1e293b]" className="text-white shadow-[12px_12px_0_0_#000] lg:translate-y-8" title="OBJETIVO_ST">
          ...
          <CinematicCard color="bg-white" className="text-black shadow-[12px_12px_0_0_#3b82f6]" title="DATO_CRÍTICO">
