...
export const Quiz3153 = ({ onComplete }: { onComplete: (result: QuizResult) => void }) => {
  ...
  if (isFinished) {
    ...
    return (
      <div className="py-24 px-6 bg-[#3b82f6]/10 min-h-[60vh] flex items-center justify-center border-t-8 border-black">
