/**
 * GRAFO MULTICAMINO - ARTÍCULO 3453
 ...
 *
 * Estructura: Grafo dirigido con condiciones de desbloqueo y finales alternativos
 * Todo el contenido es fiel al artículo original.
 */

import type { ArticleGraph } from './types';

export const graph3453: ArticleGraph = {
  id: '3453',
  ...
  nodes: {
    // ═══════════════════════════════════════════════════════════
    // NODO INICIAL: Perfil de entrada
    // ═══════════════════════════════════════════════════════════
    bienvenida: {
      id: 'bienvenida',
    ...
    marco_legal: {
      ...
      exits: [
        { to: 'critica_protocolos', label: '¿Funcionan estos protocolos?', type: 'profundidad', icon: 'MessageCircle', requiresVisited: ['resultados_protocolo'] },
    ...
    critica_protocolos: {
      ...
      accentColor: '#e67e22',
      content: `Esta sección se desbloquea después de conocer los resultados sobre el protocolo escolar. El artículo cita a **Córdova et al. (2022)**:`,
      quote: {
        ...
        context: 'Percepción de actores educativos sobre protocolos de actuación en conductas de consumo',
      },
      exits: [
    ...
    // ═══════════════════════════════════════════════════════════
    // RAMA: PERFIL DE DOCENTES (profundidad temprana)
    // ═══════════════════════════════════════════════════════════
    perfil_docentes: {
      id: 'perfil_docentes',
    ...
    discusion_tension: {
      ...
      exits: [
        ...
        { to: 'final_cuidado', label: 'Reflexionar sobre el cuidado', type: 'final', icon: 'Heart', requiresVisited: ['discusion_tension', 'discusion_formacion'] },
      ],
    },
