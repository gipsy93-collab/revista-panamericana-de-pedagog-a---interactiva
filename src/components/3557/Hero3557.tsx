...
import { Scale, Cpu, Users } from 'lucide-react';

export const Hero3557 = () => {
  return (
    <section className="relative min-h-[90vh] bg-[#f0f0f0] flex flex-col justify-center px-6 md:px-12 lg:px-24 py-20 overflow-hidden">
      ...
      <div className="absolute top-0 right-0 w-1/2 h-full bg-[#3b82f6]/10 -skew-x-12 translate-x-20 z-0" />
      
      <div className="relative z-10 max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
        <div className="lg:col-span-8 flex flex-col gap-8">
          <BrutalSticker 
            text="ESTUDIO MIXTO // PEDAGOGÍA JURÍDICA" 
            color="bg-[#3b82f6]" 
            className="text-white self-start"
          />
          
          <PremiumTitle subtitle="DERECHO DIGITAL">
            {ARTICLE_META.title}
          </PremiumTitle>
          ...
          <div className="flex flex-wrap gap-6 mt-4">
            <div className="flex items-center gap-3 bg-black text-white px-5 py-3 border-2 border-black shadow-[6px_6px_0_0_#3b82f6]">
              <Users size={20} />
            ...
            <div className="flex items-center gap-3 bg-white text-black px-5 py-3 border-2 border-black shadow-[6px_6px_0_0_#000]">
              <Cpu size={20} />
              <span className="font-mono text-sm font-bold uppercase">{ARTICLE_META.stats.res}</span>
            </div>
            <div className="flex items-center gap-3 bg-white text-black px-5 py-3 border-2 border-black shadow-[6px_6px_0_0_#000]">
              <Scale size={20} />
